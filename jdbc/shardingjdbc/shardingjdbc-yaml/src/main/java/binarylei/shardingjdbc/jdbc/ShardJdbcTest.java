...
public class ShardJdbcTest {
    public static void main(String[] args) throws SQLException {
        ...
        dataSource1.setUrl("jdbc:mysql://localhost:3306/shard0?serverTimezone=UTC");
        ...
        dataSource2.setUrl("jdbc:mysql://localhost:3306/shard1?serverTimezone=UTC");
        ...
        DataSource dataSource = ShardingDataSourceFactory.createDataSource(
                dataSourceMap, shardingRuleConfig, map, new Properties());
