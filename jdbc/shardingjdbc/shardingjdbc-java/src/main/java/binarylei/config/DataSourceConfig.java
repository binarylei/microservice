 ...
 */
@Configuration
@MapperScan(basePackages = "binarylei.shardingjdbc.mapper", sqlSessionFactoryRef = "sqlSessionFactory")
public class DataSourceConfig {
    ...
    public DataSource shardingDataSource() throws SQLException {
        ...
        // 默认的分库策略
        src.setDefaultDatabaseShardingStrategyConfig(
                new StandardShardingStrategyConfiguration(
                        "user_id", DBShardAlgo.class.getName()));
        // 默认的分表策略
        src.setDefaultTableShardingStrategyConfig(
                new StandardShardingStrategyConfiguration(
                        "user_id", TblPreShardAlgo.class.getName(),
                        TblRangeShardAlgo.class.getName()));
