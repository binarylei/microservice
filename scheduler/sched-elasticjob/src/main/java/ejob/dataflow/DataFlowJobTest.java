...
public class DataFlowJobTest {
    ...
    public static void main(String[] args) {
        ...
        CoordinatorRegistryCenter regCenter = new ZookeeperRegistryCenter(
                new ZookeeperConfiguration("192.168.139.101:2181", "sched-elasticjob"));
        regCenter.init();

        // 定义作业核心配置
        JobCoreConfiguration dataJobCoreConfig = JobCoreConfiguration.newBuilder(
                "MyDataFlowJob", "0/4 * * * * ?", 2).build();
        // 定义DATAFLOW类型配置
